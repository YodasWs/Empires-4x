...
Thank you for your interest in contributing to the game project, **Roman Logistics Tycoon**.
...
1.  **Definitions**
    ...
    *   **"Project"** means the software and any associated materials maintained at https://github.com/YodasWs/RomanLogisticsTycoon.
...
3.  **Future License Changes**
    *   You acknowledge that the Project is currently licensed under [`LICENSE.md`](https://github.com/YodasWs/RomanLogisticsTycoon/blob/master/LICENSE.md), an open-source license.
