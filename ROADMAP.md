# 🗺️ Project Roadmap
Welcome to the roadmap for Roman Logistics Tycoon! This document provides an overview of our development plans and direction. This is a living document and may be updated as we progress and gather feedback.

We welcome community contributions! Please check out our [CONTRIBUTING.md](https://github.com/YodasWs/RomanLogisticsTycoon/tree/master?tab=contributing-ov-file) for guidelines on how to get started.
...
- **Core Mechanics**:
  ...
  - [x] Farms produce Food at the start of each round.
    [Issue #4](https://github.com/YodasWs/RomanLogisticsTycoon/issues/4)
  - [x] Food has to move to the City to give the Player money.
    [Issue #11](https://github.com/YodasWs/RomanLogisticsTycoon/issues/11)
  - [ ] Let the Player change Laborer assignments.
    [Issue #19](https://github.com/YodasWs/RomanLogisticsTycoon/issues/19)
  - [ ] Let the Player hire more Workers and Laborers.
    [Issue #18](https://github.com/YodasWs/RomanLogisticsTycoon/issues/18)
- **UI Elements**: Add the most essential user interface elements, like letting the Player move the Units and perform actions and see territory claims on each Tile.
  - [ ] [Notify Player of start of turn](https://github.com/YodasWs/RomanLogisticsTycoon/issues/6)
  - [x] [Some basic UI needs](https://github.com/YodasWs/RomanLogisticsTycoon/issues/22)
  - [ ] [Tile information screen](https://github.com/YodasWs/RomanLogisticsTycoon/issues/20)
...
- [ ] [Action buttons](https://github.com/YodasWs/RomanLogisticsTycoon/issues/27) on screen.
- [ ] [Side panel](https://github.com/YodasWs/RomanLogisticsTycoon/issues/30) listing units on the selected tile.
- [ ] [Title Screen](https://github.com/YodasWs/RomanLogisticsTycoon/issues/3)
- [ ] [Main Menu](https://github.com/YodasWs/RomanLogisticsTycoon/issues/2)
- [ ] [Settings Screen](https://github.com/YodasWs/RomanLogisticsTycoon/issues/43)
- [ ] [Map Overlays](https://github.com/YodasWs/RomanLogisticsTycoon/issues/39)
